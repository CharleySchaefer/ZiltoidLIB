...
#set xlabel "Time (s)" font "Arial, 36" offset 0,-0.8
...
set label "EPYC1" at 0.11, 0.6666*0.8660-0.11*0.6666*0.8660 rotate by 60 centre  font "Arial, 36" offset 0,-0.8
set label "Rubisco" at 0.5, -0.14 centre  font "Arial, 36" offset 0,-0.8
set label "Water" at 0.91*1.0, 0.91*0.6*0.866 rotate by -60 centre  font "Arial, 36" offset 0,-0.8

set label "0.0" at 0.0, -0.05 right  font "Arial, 24" offset 0,-0.8
set label "0.2" at 0.2, -0.05 right  font "Arial, 24" offset 0,-0.8
set label "0.4" at 0.4, -0.05 right  font "Arial, 24" offset 0,-0.8
set label "0.6" at 0.6, -0.05 right  font "Arial, 24" offset 0,-0.8
set label "0.8" at 0.8, -0.05 right  font "Arial, 24" offset 0,-0.8
set label "1.0" at 1.0, -0.05 right  font "Arial, 24" offset 0,-0.8

set label "0.0" at 1.05, 0.0*0.866 left  font "Arial, 24" offset 0,-0.8
set label "0.2" at 0.95, 0.2*0.866 left  font "Arial, 24" offset 0,-0.8
set label "0.4" at 0.85, 0.4*0.866 left  font "Arial, 24" offset 0,-0.8
set label "0.6" at 0.75, 0.6*0.866 left  font "Arial, 24" offset 0,-0.8
set label "0.8" at 0.65, 0.8*0.866 left  font "Arial, 24" offset 0,-0.8
set label "1.0" at 0.55, 1.0*0.866 left  font "Arial, 24" offset 0,-0.8

set label "1.0" at -0.03, 0.052 right  font "Arial, 24" offset 0,-0.8
set label "0.8" at 0.07, 0.2252 right  font "Arial, 24" offset 0,-0.8
set label "0.6" at 0.1700, 0.3984 right  font "Arial, 24" offset 0,-0.8
set label "0.4" at 0.2700, 0.5716 right  font "Arial, 24" offset 0,-0.8
set label "0.2" at 0.3700, 0.7448 right  font "Arial, 24" offset 0,-0.8
set label "0.0"at 0.47,0.918 right  font "Arial, 24" offset 0,-0.8
...
plot 	"< gawk 'NR>1{print ($2+2*$1)/(2*($1+$2+$3)), sqrt(3)*$2/(2*($1+$2+$3))}' VolumeFractions.txt" notitle w p pt 6 ps 2  lw 8 lc rgb "red" 
